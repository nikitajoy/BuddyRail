...
<v-container>
    ...
    <div class="train">
        <div class="d-flex justify-center flex-wrap">
            ...
            <!-- WHEELS -->
            <path d="M180.14,185.89l-1.88-.66.66-1.89a1,1,0,0,0-1.89-.66l-.66,1.89-1.89-.66a1,1,0,0,0-.66,1.89l1.89.66-.66,1.88a1,1,0,1,0,1.88.67l.66-1.89,1.89.66a1,1,0,1,0,.66-1.89Z"  transform="translate(-18.76 -109.92)"
            >
        </path>
